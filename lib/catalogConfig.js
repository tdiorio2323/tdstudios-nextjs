...
export const catalogConfigs = {
  designs: {
    ...
    watermarkImage: '/images/td-studios-logo-tnt.png',
  ...
  vday: {
    ...
    description: "Browse our Valentine's Day design collection.",
    watermarkImage: '/images/td-studios-logo-tnt.png',
    watermarkAlt: 'TD Studios',
  },
  nerds: {
    title: 'Nerds',
    description: 'Browse our Nerds design collection.',
    watermarkImage: '/images/td-studios-logo-tnt.png',
    watermarkAlt: 'TD Studios',
  },
  flipz: {
    title: 'Flipz',
    description: 'Browse our Flipz design collection.',
    watermarkImage: '/images/td-studios-logo-tnt.png',
    watermarkAlt: 'TD Studios',
  },
  pocky: {
    title: 'Pocky',
    description: 'Browse our Pocky design collection.',
    watermarkImage: '/images/td-studios-logo-tnt.png',
    watermarkAlt: 'TD Studios',
  },
  faygo: {
    title: 'Faygo',
    description: 'Browse our Faygo design collection.',
    watermarkImage: '/images/td-studios-logo-tnt.png',
    watermarkAlt: 'TD Studios',
  },
  bagman: {
    ...
    watermarkImage: '/images/bagman-logo.png',
    watermarkAlt: 'Bagman NY',
  },
}
