...
const config = catalogConfigs.faygo

export default function FaygoDesigns() {
  ...
  const fetchDesigns = useCallback(async () => {
    try {
      ...
      const res = await fetch('/api/faygo')
      ...
      console.error('[FaygoDesigns] Error fetching designs:', err)
