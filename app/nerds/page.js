...
const config = catalogConfigs.nerds

export default function NerdsDesigns() {
  ...
  const fetchDesigns = useCallback(async () => {
    try {
      ...
      const res = await fetch('/api/nerds')
      ...
      console.error('[NerdsDesigns] Error fetching designs:', err)
