...
const config = catalogConfigs.flipz

export default function FlipzDesigns() {
  ...
  const fetchDesigns = useCallback(async () => {
    try {
      ...
      const res = await fetch('/api/flipz')
      ...
      console.error('[FlipzDesigns] Error fetching designs:', err)
